...
{
    // Maak een instantie van de RootViewController aan. Deze erft van UITableViewController
    ...
    [self.window setRootViewController:rootController]; // Geef aan dat de net aangemaakte controller als eerste moet worden getoond
