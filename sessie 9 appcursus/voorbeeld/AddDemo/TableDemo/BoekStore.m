...
- (void) voegBoekToe:(Boek*) boek
{
    ...
    NSString * path = @"http://still-brook-6654.herokuapp.com/books";
    
    [[NSNotificationCenter defaultCenter] postNotification:[NSNotification notificationWithName:@"BoekStoreUpdate" object:self]];
}
