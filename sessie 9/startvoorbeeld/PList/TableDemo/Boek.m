...
- (id)initBoekWithJSON: (id)json
{
    return [self initBookWithAuthor:[json valueForKey:@"author"] andTitle:[json valueForKey:@"title"]];
}
...
+ (id)boekWithJSON: (id)json
{
    return [[Boek alloc] initBoekWithJSON:json];
}
